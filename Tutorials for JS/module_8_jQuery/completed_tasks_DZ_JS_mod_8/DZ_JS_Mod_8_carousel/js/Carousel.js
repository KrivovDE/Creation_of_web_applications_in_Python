...
//ДОБАВЛЕНИЕ КНОПОК
imgDiv =
  '<button type="button" role="presentation" class="owl-play"><img src="img/play.png" alt="P"></button>';
$(".owl-prev").after(imgDiv);
imgDiv =
  '<button type="button" role="presentation" class="owl-first disabled"><img src="img/first.png" alt="F"></button>';
$(".owl-nav").prepend(imgDiv);
imgDiv =
  '<button type="button" role="presentation" class="owl-last"><img src="img/last.png" alt="L"></button>';
