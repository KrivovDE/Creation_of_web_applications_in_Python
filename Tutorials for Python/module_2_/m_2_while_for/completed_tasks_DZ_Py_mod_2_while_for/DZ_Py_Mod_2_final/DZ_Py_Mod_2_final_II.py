...
try:
    ...
    for i in range(X + Y - 1):
        ...
        elif i < residue * 3:      #если у нас есть остаток то каждая 3 машина будет стоять одна
...
import random
print('Тест на знание таблицы умножения, каждые 5 примеров сложность '
...
if interest_answer >= 86:
    ...
    print('\nПлохой результат\n'
          'Оценка 2 - балла')
print(f'Верные ответы - {correct_answer}\nНе верные ответы - {wrong_answer}\n'
